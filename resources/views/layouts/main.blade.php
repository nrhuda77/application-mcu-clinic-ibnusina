...
<head>
    ...
    <title>Admin MCU Ibnu Sina</title>
    ...
    <!-- css table modal -->
    <link rel="stylesheet" href="{{ asset('assets/vendor/css/custom-overrides.css') }}" />
        ...
        <div class="layout-container">
            <!-- Menu -->
                    ...
                    @if(Auth::user()->role == 'Admin Perusahaan')
                        @include('layouts.sidebar-admin.sidebar_admin_perusahaan')
                    @else
