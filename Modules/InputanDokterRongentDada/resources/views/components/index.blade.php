    ...
    <link href="https://cdn.jsdelivr.net/npm/summernote@0.9.0/dist/summernote-lite.min.css" rel="stylesheet">
     ...
     <div class="content-wrapper blocking">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
             ...
             <x-inputandokterrongentdada::content :data="$data" :norawat="$no_rawat" :reg="$reg"></x-inputandokterrongentdada::content>
     ...
     <x-inputandokterrongentdada::script :temuan="$data?->hasil"  :norawat="$no_rawat" :reg="$reg"></x-inputandokterrongentdada::script>
