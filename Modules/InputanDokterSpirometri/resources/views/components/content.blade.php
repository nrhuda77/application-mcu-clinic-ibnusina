                ...
                <div class="col-xl-12 col-lg-12 col-md-12">
                  ...
                  <div class="card mb-6">
                    <div class="card-body row">
                     <p class="card-text text-uppercase text-body-secondary small mb-0">Hasil Inputan Audiogram</p>
                  ...
                  <div class="row justify-content-center">
                     ...
                     <div class="col-lg-6">  
                      ...
                      @if ($data != null)
                         <div class="col-lg-12">  <iframe id="pdfFrame" src="/pdf-preview-temuan-spirometri/{{ $norawat }}"  width="100%" height="570px"></iframe></div>
