...
@section('content')
     ...
     <div class="content-wrapper blocking">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                  ...
                  <div class="nav-align-top">
                    <ul class="nav nav-pills flex-column flex-sm-row mb-6 gap-sm-0 gap-2">
                        ...
                        <li class="nav-item">
                         ...
                         <li class="nav-item">
                        <a class="nav-link active bg-danger" onclick="alerts()"
                      ...
                      @else
                       ...
                       <li class="nav-item">
                        <a class="nav-link active" href="/pemeriksaan-gigi"
             ...
             <x-pemeriksaangigi::content :data="$data" :gigi="$gigi" ></x-pemeriksaangigi::content>
         ...
         <x-pemeriksaangigi::modal ></x-pemeriksaangigi::modal>
     ...
     <x-pemeriksaangigi::script></x-pemeriksaangigi::script>
