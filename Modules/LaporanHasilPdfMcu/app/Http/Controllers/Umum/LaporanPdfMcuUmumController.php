...
namespace Modules\LaporanHasilPdfMcu\Http\Controllers\Umum;
...
class LaporanPdfMcuUmumController extends Controller
{
...
$pdf->Image($tempFile, 30, 75, 140);
   ...
   $link_stamp_dokter = url('qrcode/dokter-penanggungjawab/'.$no_rawat);
    ...
    $result->saveToFile($filepath);
     ...
     $link = url('detail-laporan-pdf-pasien-mcu/umum/'.$no_rawat);
    ...
    $result->saveToFile($filepath);
     ...
     SertifikatHasilController::index($pdf, $norwt);
