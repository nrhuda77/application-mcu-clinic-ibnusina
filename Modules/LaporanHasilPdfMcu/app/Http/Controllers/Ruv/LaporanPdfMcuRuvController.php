...
namespace Modules\LaporanHasilPdfMcu\Http\Controllers\Ruv;
...
class LaporanPdfMcuRuvController extends Controller
{
...
$pdf->Image($tempFile, 30, 75, 140);
    ...
    $result->saveToFile($filepath);
     ...
     $link = url('detail-laporan-pdf-pasien-mcu/RU-V/'.$no_rawat);
    ...
    $result->saveToFile($filepath);
     ...
     SertifikatHasilController::index3($pdf, $norwt);
