    ...
    <link href="https://cdn.jsdelivr.net/npm/summernote@0.9.0/dist/summernote-lite.min.css" rel="stylesheet">
     ...
     <div class="content-wrapper blocking">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
             ...
             <x-inputandokteraudiogram::content :data="$data" :norawat="$no_rawat" :reg="$reg"></x-inputandokteraudiogram::content>
     ...
     <x-inputandokteraudiogram::script :temuan="$data?->hasil" :saran="$data?->catatan_hasil" :norawat="$no_rawat" :reg="$reg"></x-inputandokteraudiogram::script>
