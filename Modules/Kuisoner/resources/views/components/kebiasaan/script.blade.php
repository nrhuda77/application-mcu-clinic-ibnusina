  ...
  function edit(no_rawat)
   {
      ...
      zIndex: 9999 // Gerakkan elemen 20px ke atas
       ...
       //Ajax Load data from ajax
       $.ajax({
           url : '/get-riwayat-kebiasaan/' + no_rawat,
           type: "GET",
           dataType: "JSON",
           success: function(data)
           {
               ...
               $('.no_rawat').val(data.reg.no_rawat);
                ...
                $('[name="merokok"]').val(data.riwayat.merokok); 
               $('[name="kopi"]').val(data.riwayat.kopi); 
               $('[name="olahraga"]').val(data.riwayat.olahraga); 
              //  $('[name="tidur"]').val(data.riwayat.tidur); 
               $('[name="alkohol"]').val(data.riwayat.alkohol); 

               $('[name="keterangan_merokok"]').val(data.riwayat.keterangan_merokok); 
               $('[name="keterangan_kopi"]').val(data.riwayat.keterangan_kopi); 
               $('[name="keterangan_olahraga"]').val(data.riwayat.keterangan_olahraga); 
              //  $('[name="keterangan_tidur"]').val(data.riwayat.keterangan_tidur); 
               $('[name="keterangan_alkohol"]').val(data.riwayat.keterangan_alkohol);  
...
function save_kuisoner()

   {
       ...
       if(save_method == 'update'){
        url = "/update-riwayat-kebiasaan";
       }else{
        url = "/insert-riwayat-kebiasaan";
       }
  ...
  function() {
    ...
    $.ajax({
        url : "/delete-riwayat-kebiasaan/" + no_rawat,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
