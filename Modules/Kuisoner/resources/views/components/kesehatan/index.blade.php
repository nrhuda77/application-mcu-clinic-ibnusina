...
@section('content')
     ...
     <div class="content-wrapper blocking">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                  ...
                  <div class="nav-align-top">
                    <ul class="nav nav-pills flex-column flex-sm-row mb-6 gap-sm-0 gap-2">
                      ...
                      @else
                       ...
                       <li class="nav-item">
                        <a class="nav-link active" href="/riwayat-kesehatan"
             ...
             <x-kuisoner::kesehatan.content :data="$data" :riwayat="$riwayat" :riwayat2="$riwayat2" :riwayat3="$riwayat3"></x-kuisoner::kesehatan.content>
     ...
     <x-kuisoner::kesehatan.script></x-kuisoner::kesehatan.script>
