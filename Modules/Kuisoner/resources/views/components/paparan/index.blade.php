...
@section('content')
     ...
     <div class="content-wrapper blocking">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                  ...
                  <div class="nav-align-top">
                    <ul class="nav nav-pills flex-column flex-sm-row mb-6 gap-sm-0 gap-2">
                      ...
                      @else
                       ...
                       <li class="nav-item">
                        <a class="nav-link active" href="/riwayat-paparan"
             ...
             <x-kuisoner::paparan.content :data="$data" :riwayat="$riwayat" :riwayat2="$riwayat2" ></x-kuisoner::paparan.content>
     ...
     <x-kuisoner::paparan.script></x-kuisoner::paparan.script>
