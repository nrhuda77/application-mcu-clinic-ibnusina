...
@section('content')
     ...
     <div class="content-wrapper blocking">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <div class="col-md-12">
                  <div class="nav-align-top">
                    <ul class="nav nav-pills flex-column flex-sm-row mb-6 gap-sm-0 gap-2">
                         ...
                         @if($data == null)
                             <li class="nav-item">
                         <a class="nav-link active bg-success" onclick="kuisoner('{{ $no_rawat }}')">
                          <i class="icon-base ti tabler-plus icon-sm me-1_5"></i> Tambah Data</a>
                      </li>

                      <li class="nav-item">
                        <a class="nav-link active bg-warning" onclick="alerts2()"
                          ><i class="icon-base ti tabler-edit icon-sm me-1_5"></i> Edit Data</a>
                      </li>
                      ...
                      @else
                       ...
                       <li class="nav-item">
                         <a class="nav-link active bg-success" onclick="alerts()">
                          <i class="icon-base ti tabler-plus icon-sm me-1_5"></i> Tambah Data</a>
                       </li>

                       <li class="nav-item">
                        <a class="nav-link active bg-warning" onclick="edit('{{ $no_rawat }}')"
                          ><i class="icon-base ti tabler-edit icon-sm me-1_5"></i> Edit Data</a>
                      </li>
                       ...
                       <li class="nav-item">
                        <a class="nav-link active" href="/riwayat-penyakit-keluarga"
             ...
             <x-kuisoner::penyakit-keluarga.content :data="$data" :riwayat="$riwayat" :riwayat2="$riwayat2" :riwayat3="$riwayat3"></x-kuisoner::penyakit-keluarga.content>
     ...
     <x-kuisoner::penyakit-keluarga.script></x-kuisoner::penyakit-keluarga.script>
