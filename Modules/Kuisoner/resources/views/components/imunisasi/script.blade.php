  ...
  function edit(no_rawat)
   {
      ...
      zIndex: 9999 // Gerakkan elemen 20px ke atas
       ...
       //Ajax Load data from ajax
       $.ajax({
           url : '/get-riwayat-imunisasi/' + no_rawat,
           type: "GET",
           dataType: "JSON",
           success: function(data)
           {
               ...
               $('.no_rawat').val(data.reg.no_rawat);
                 ...
                 $('[name="hep_a"]').val(data.riwayat.hep_a); 
               $('[name="hep_b"]').val(data.riwayat.hep_b); 
              //  $('[name="bcg"]').val(data.riwayat.bcg); 
              //  $('[name="polio"]').val(data.riwayat.polio); 
              //  $('[name="dpt"]').val(data.riwayat.dpt); 

              //  $('[name="tetanus"]').val(data.riwayat.tetanus); 
              //  $('[name="campak"]').val(data.riwayat.campak); 

              //  $('[name="typhoid"]').val(data.riwayat.typhoid); 
              //  $('[name="rubela"]').val(data.riwayat.rubela); 
               $('[name="covid19"]').val(data.riwayat.covid19);  
...
function save_kuisoner()

   {
       ...
       if(save_method == 'update'){
        url = "/update-riwayat-imunisasi";
       }else{
        url = "/insert-riwayat-imunisasi";
       }
  ...
  function() {
    ...
    $.ajax({
        url : "/delete-riwayat-imunisasi/" + no_rawat,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
