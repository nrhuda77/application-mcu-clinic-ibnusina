...
namespace Modules\InputanHasilDokter\Http\Controllers;
...
class InputanHasilDokterController extends Controller
{
    ...
    $jns = DB::table('hasil_inputan_dokter_mcu')->where('no_rawat', $val->no_rawat)->where('jenis', 'hasil')->first();
   ...
   $kt = '  <a class="dropdown-item text-warning" href="/detail-hasil-inputan-dokter-umum/'.$no_rawat.'"><i class="icon-base ti tabler-app-window me-1"></i>Umum</a>
           <a class="dropdown-item text-warning" href="/detail-hasil-inputan-dokter-rdmp/'.$no_rawat.'"><i class="icon-base ti tabler-app-window me-1"></i>RDMP</a>
            <a class="dropdown-item text-warning" href="/detail-hasil-inputan-dokter-ruv/'.$no_rawat.'"><i class="icon-base ti tabler-app-window me-1"></i>RU V</a>
   ';
