...
namespace Modules\InputanHasilDokter\Http\Controllers\Rdmp;
...
class CrudInputanDokterController extends Controller
{
     public static function store(Request $request) {
        try {
            ...
            DB::table('hasil_inputan_dokter_mcu2')->insert([
    ...
    public static function update(Request $request) {
        try{
            ...
            $data = request()->all();
            $data = request()->except(['_token']);
            DB::table('hasil_inputan_dokter_mcu2')->where('no_rawat',$no_rwt)->update($data);
    ...
    public static function destroy($no_rawat) {
        ...
        DB::table('hasil_inputan_dokter_mcu2')->where('no_rawat', $no_rwt)->delete();
        return response()->json(['status' => 'success']);
    }
  ...
  
    {
        ...
        $exists = DB::table('hasil_inputan_dokter_mcu2')->where('no_rawat', $no_rawat)->exists();

        if ($exists) {
            DB::table('hasil_inputan_dokter_mcu2')
