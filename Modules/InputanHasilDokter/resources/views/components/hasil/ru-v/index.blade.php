    ...
    <link href="https://cdn.jsdelivr.net/npm/summernote@0.9.0/dist/summernote-lite.min.css" rel="stylesheet">
     ...
     <div class="content-wrapper blocking">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
             ...
             <x-inputanhasildokter::hasil.ru-v.content :data="$data" :norawat="$no_rawat" :reg="$reg"></x-inputanhasildokter::hasil.ru-v.content>
     ...
     <x-inputanhasildokter::hasil.ru-v.script :temuan="$data?->temuan" :saran="$data?->saran" :norawat="$no_rawat" :reg="$reg"></x-inputanhasildokter::hasil.ru-v.script>
