    ...
    <link href="https://cdn.jsdelivr.net/npm/summernote@0.9.0/dist/summernote-lite.min.css" rel="stylesheet">
     ...
     <div class="content-wrapper blocking">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                  ...
                  <div class="nav-align-top">
                    <ul class="nav nav-pills flex-column flex-sm-row mb-6 gap-sm-0 gap-2">
                      ...
                      @else
                       ...
                       <li class="nav-item">
                        <a class="nav-link active" href="/hasil-inputan-dokter-umum"
             ...
             <x-inputanhasildokter::hasil.umum.content :data="$data" :norawat="$no_rawat" :reg="$reg"></x-inputanhasildokter::hasil.umum.content>
     ...
     <x-inputanhasildokter::hasil.umum.script :temuan="$data?->hasil" :saran="$data?->catatan_hasil" :norawat="$no_rawat" :reg="$reg"></x-inputanhasildokter::hasil.umum.script>
