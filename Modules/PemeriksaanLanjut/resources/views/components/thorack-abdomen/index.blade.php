...
@section('content')
     ...
     <div class="content-wrapper blocking">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                  ...
                  <div class="nav-align-top">
                    <ul class="nav nav-pills flex-column flex-sm-row mb-6 gap-sm-0 gap-2">
                      ...
                      @else
                       ...
                       <li class="nav-item">
                        <a class="nav-link active" href="/thoraks-abdomen"
             ...
             <x-pemeriksaanlanjut::thorack-abdomen.content :data="$data" :pemeriksaan="$pemeriksaan" ></x-pemeriksaanlanjut::thorack-abdomen.content>
     ...
     <x-pemeriksaanlanjut::thorack-abdomen.script></x-pemeriksaanlanjut::thorack-abdomen.script>
