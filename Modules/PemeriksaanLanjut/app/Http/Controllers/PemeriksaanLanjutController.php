...
namespace Modules\PemeriksaanLanjut\Http\Controllers;
...
class PemeriksaanLanjutController extends Controller
{
    ...
    foreach ($data as $val) {
        ...
        $tables = [
    'vital-kondisi-umum' => 'vital_kondisi_umum_mcu',
    'fisik-kulit-mata' => 'pemeriksaan_kulit_mata_tht_mcu',
    'thoraks-abdomen' => 'pemeriksaan_thoraks_abdomen_mcu',
    'genital-anus' => 'pemeriksaan_genital_vertebra_mcu',
];
