...
function autoSaveContent(content) {
    ...
    timeout1 = setTimeout(function () {
      ...
      zIndex: 9999 // Gerakkan elemen 20px ke atas
        ...
        $.ajax({
            url: "/auto-save-temuan-elektrokardiogram",
            method: "POST",
            data: {
            ...
            success: function (res) {
                $('#pdfFrame').attr('src', '/pdf-preview-temuan-elektrokardiogram/' + '{{ $norawat }}');
...
cancelButtonBackground: '#a9a9a9',
  ...
  function() {
    ...
    $.ajax({
        url : "/delete-hasil-inputan-dokter-elektrokardiogram/" + no_rawat,
        type: "GET",
        dataType: "JSON",
