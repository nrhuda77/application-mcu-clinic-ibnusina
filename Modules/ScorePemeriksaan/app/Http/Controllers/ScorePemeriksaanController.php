...
namespace Modules\ScorePemeriksaan\Http\Controllers;

use App\Http\Controllers\Controller;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Crypt;
use Illuminate\Support\Facades\DB;
class ScorePemeriksaanController extends Controller
{
    ...
    foreach ($data as $val) {
        ...
        $tables = [
    'score-pemeriksaan-napfa' => 'score_pemeriksaan_napfa',
    'score-jakarta-cardiovascular' => 'score_jakarta_cardiovascular',
];
